    ...
    <div>
      ...
      {isModalOpen && (
        <div
          ...
          style={{ animation: isModalOpen ? `fadeIn 1s` : "none" }}
        >
          <form onSubmit={onSubmit} className={s.modalContent}>
              ...
              <div className={s.toggleSwitch} onClick={toggleTransactionType}>
                <div
                  className={`${s.toggleButton} ${
                    isIncome ? s.income : s.expense
                  }`}
                >
                  {isIncome ? (
                    <img src={Image.plus} alt="Income" />
                  ) : (
                    <img src={Image.minus} alt="Expense" />
                  )}
                </div>
              </div>
              <span
                className={`${s.toggleOption} ${
                  !isIncome ? s.activeExpense : ""
                }`}
                onClick={toggleTransactionType}
              >
                Expense
            ...
            {!isIncome && (
              <div className={s.select}>
                ...
                >
                  ...
                  <option className={s.selectTitle} value="MainExpenses">
                    Main expenses
                  </option>
                  <option className={s.selectTitle} value="Products">
                    Products
                  </option>
                  <option className={s.selectTitle} value="Car">
                    Car
                  </option>
                  <option className={s.selectTitle} value="Selfcare">
                    Self care
                  </option>
                  <option className={s.selectTitle} value="Childcare">
                    Child care
                  </option>
                  <option className={s.selectTitle} value="Household">
                    Household
                  </option>
                  <option className={s.selectTitle} value="Education">
                    Education
                  </option>
                  <option className={s.selectTitle} value="Leisure">
                    Leisure
                  </option>
                  <option className={s.selectTitle} value="Other">
                    Other
                  </option>
                </select>
              </div>
            ...
            <button type="submit" className={s.addButtonPrimary}>
